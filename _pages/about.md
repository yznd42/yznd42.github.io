...
I am a postdoctoral research associate in [the Social Sensing & Intelltence Lab](https://www.wangdong.org/sslab/index.html) at [the University of Illinois Urbana-Champaign (UIUC)](https://illinois.edu/). I received my Ph.D. in Computer Science and Engineering from [the University of Notre Dame](https://www.nd.edu/). Before that, I got my M.S. in Data Science from [Indiana University](https://www.indiana.edu/) and attained my B.S. in Software Engineering from [Wuhan University](https://www.whu.edu.cn/).  I have also worked as the W. J. Cody Research Associates at [Argonne National Laboratory](https://www.anl.gov/). I have authored and co-authored [60+]() peer-reviewed conference/journal papers, including [28]() first-authored ones, in various highly competitive [human-centered AI]() and [social sensing and computing]() venues such as ACM CSCW, IEEE BigData, ACM/IEEE ASONAM, AAAI, IJCAI, ACM WWW, AAAI HCOMP, RTSS, IEEE TBD, IEEE TCSS, ACM/IEEE IWQoS, IEEE SECON, ACM RecSys, Elsevier KBS.
